...
class trainer_tester:
    def __init__(self):
        ...
        #self.encoderdecoder.load_state_dict(torch.load('state_dicts/encoderdecoder-1586575606_0'))
...
def main():
    ...
    print("network declared")
    #network.render_framerange(0, 500, 600, 'optic_first')
    network.train()
